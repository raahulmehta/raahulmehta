...
| 10 | **Fertility Minds** `📱` | Cross-platform app — Apple(https://apps.apple.com/in/app/fertility-minds/id6786222520)/Google, Auth, Stripe subscriptions, real-time Socket.io chat, push notifications, social posting, custom CMS/CRM + React admin panel, And Store listing and deployment management,  | `React Native` `Node.js` `MongoDB` `Socket.io` `Stripe` | Oct 2025–Feb 2026 |
